...
def calculate_insertion_cost(vehicle, customer, distances, position, period):
    ...
    if new_duration <= vehicle.max_duration and new_load <= vehicle.capacity:
        return added_duration * vehicle.variable_cost, True
    else:
    ...
    for customer in frequent_customers:
        for period in customer.required_periods:
            ...
            if best_vehicle:
                ...
                template_routes[customer.id] = (best_vehicle, period)
